...
export const api = {
  ...
  createSession: (request_token: string) => post<{ access_token: string; connected: boolean }>("/auth/session", { request_token }),
  authStatus: () => get<{ connected: boolean; broker: string }>("/auth/status"),
