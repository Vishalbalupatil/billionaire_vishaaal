# AI Trader — Nifty 50 Options

> **AI-powered trading platform for Indian equity & options markets (Nifty 50)
...
- **Real-time Dashboard** — React + TypeScript + Tailwind CSS with dark theme,
  live signal feed, payoff diagrams, risk monitor
- **Market Data Pipeline** — Kite WebSocket ticks → multi-timeframe candle
  builder → indicator engine → AI signals
...
├── strategy/              Strategy engine, technical indicators
